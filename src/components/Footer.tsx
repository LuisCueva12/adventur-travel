            ...
            <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-2xl font-bold bg-gradient-to-r from-green-600 to-emerald-700 bg-clip-text text-transparent">Aventuras</span>
                        </div>
                        ...
                        <div className="flex space-x-6">
                            {[
                                ...
                                { name: 'YouTube', icon: 'M8.051 1.999h.089c.822.003 4.987.033 6.11.335a2.01 2.01 0 0 1 1.415 1.42c.101.38.172.883.22 1.402l.01.104.022.26.008.104c.065.914.073 1.77.074 1.957v.075c-.001.194-.01 1.108-.082 2.06l-.008.105-.009.104c-.05.572-.124 1.14-.235 1.558a2.007 2.007 0 0 1-1.415 1.42c-1.16.312-5.569.334-6.18.335h-.142c-.309 0-1.587-.006-2.927-.052l-.17-.006-.087-.004-.171-.007-.171-.007c-1.11-.049-2.167-.128-2.654-.26a2.007 2.007 0 0 1-1.415-1.419c-.111-.417-.185-.986-.235-1.558L.09 9.82l-.008-.104A31.4 31.4 0 0 1 0 7.68v-.123c.002-.215.01-.958.064-1.778l.007-.103.003-.052.008-.104.022-.26.01-.104c.048-.519.119-1.023.22-1.402a2.007 2.007 0 0 1 1.415-1.42c.487-.13 1.544-.21 2.654-.26l.17-.007.172-.006.086-.003.171-.007A99.788 99.788 0 0 1 7.858 2h.193zM6.4 5.209v4.818l4.157-2.408L6.4 5.209z' },
                            ].map((item) => (
                                <a 
                                    key={item.name} 
                                    href="#" 
                    ...
                    <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                <h3 className="text-sm font-semibold leading-6 text-gray-900">Destinos</h3>
                                <ul className="mt-6 space-y-4">
                                    {['Montaña', 'Playa', 'Selva', 'Desierto', 'Lagos'].map((item) => (
                                        <li key={item}>
                                            <a href="#" className="text-sm leading-6 text-gray-600 hover:text-emerald-600 transition-colors">
                                                {item}
                                            </a>
                                        </li>
                                    ))}
                            ...
                            <div className="mt-10 md:mt-0">
                                <h3 className="text-sm font-semibold leading-6 text-gray-900">Aventuras</h3>
                                <ul className="mt-6 space-y-4">
                                    {['Senderismo', 'Escalada', 'Rafting', 'Ciclismo', 'Observación'].map((item) => (
                                        <li key={item}>
                                            <a href="#" className="text-sm leading-6 text-gray-600 hover:text-emerald-600 transition-colors">
                                                {item}
                                            </a>
                        ...
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                ...
                                <ul className="mt-6 space-y-4">
                                    {['Sobre nosotros', 'Nuestro equipo', 'Blog', 'Trabaja con nosotros', 'Sostenibilidad'].map((item) => (
                                        <li key={item}>
                                            <a href="#" className="text-sm leading-6 text-gray-600 hover:text-emerald-600 transition-colors">
                                                {item}
                                            </a>
                            ...
                            <div className="mt-10 md:mt-0">
                                ...
                                <ul className="mt-6 space-y-4">
                                    {['Política de privacidad', 'Términos y condiciones', 'Política de cookies', 'Aviso legal'].map((item) => (
                                        <li key={item}>
                                            <a href="#" className="text-sm leading-6 text-gray-600 hover:text-emerald-600 transition-colors">
                                                {item}
                                            </a>
                ...
                <div className="mt-16 border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-xs leading-5 text-gray-500">
                        &copy; {new Date().getFullYear()} EcoLodge Adventures. Todos los derechos reservados.
                    </p>
                    <div className="mt-4 md:mt-0 flex space-x-6">
                        <a href="#" className="text-xs leading-5 text-gray-500 hover:text-emerald-600 transition-colors">
